      ...
      const (super: {
        ...
        gjs =
          (super.gjs.override {
            ...
            {
              doCheck = false;
            }; # avoid test dependency on gtk3
        gobject-introspection = super.gobject-introspection.override {
          x11Support = false;
        };
        gpg-tui = super.gpg-tui.override {
          x11Support = false;
        };
        gpsd = super.gpsd.override {
          guiSupport = false;
        };
        ...
        gst_all_1 = super.gst_all_1 // {
          ...
          gst-plugins-rs = super.gst_all_1.gst-plugins-rs.override {
        ...
        libextractor = super.libextractor.override {
          gtkSupport = false;
        };
        ...
        limesuite = super.limesuite.override {
          withGui = false;
        };
        ...
        neofetch = super.neofetch.override {
          x11Support = false;
        };
        ...
        pinentry-curses = super.pinentry-curses.override {
          withLibsecret = false;
        };
        pinentry-tty = super.pinentry-tty.override {
          withLibsecret = false;
        };
