...
in
{
  ...
  imports = [
    ...
    (mkRenamedOptionModule [ "services" "headscale" "database" "passwordFile" ] [
      "services"
      "headscale"
      "settings"
      "db_password_file"
    ...
    (mkRenamedOptionModule [ "services" "headscale" "tls" "letsencrypt" "hostname" ] [
      "services"
      "headscale"
      "settings"
    ...
    (mkRenamedOptionModule [ "services" "headscale" "tls" "letsencrypt" "httpListen" ] [
      "services"
      "headscale"
      "settings"
