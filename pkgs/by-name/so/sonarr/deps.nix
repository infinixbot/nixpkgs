...
[
  ...
  (fetchNuGet {
    pname = "NLog";
    version = "4.7.11";
    hash = "sha256-XEl2ISxP2sx5b+av3QVF6LWim4JPyepdnr8zA/H1b28=";
  })
  (fetchNuGet {
    pname = "NLog";
    version = "4.7.14";
    hash = "sha256-dogq2n5I62JnY+qsTnWHsLlhSvDqc5PRSjBvIBztU94=";
  })
  (fetchNuGet {
    pname = "NLog.Extensions.Logging";
    version = "1.7.4";
    hash = "sha256-RGQxi7tcoGLLn1kQbXc3cA3DUetwAwqHeDLJsXWaNNI=";
  })
  (fetchNuGet {
    pname = "NLog.Targets.Syslog";
    version = "6.0.3";
    hash = "sha256-3ZXMJzzKNFKkZn43adJgZx+fdA2TnMdfeMMl3SNkoZ0=";
  })
  (fetchNuGet {
    pname = "NodaTime";
    version = "3.0.0";
