...
(mkCoqDerivation {
  ...
  defaultVersion = lib.switch [ coq.coq-version ssreflect.version ] [
    {
      cases = [ (lib.versions.range "8.15" "8.19") lib.pred.true ];
      out = "2.0.2";
    }
    {
      cases = [ (lib.versions.range "8.13" "8.17") lib.pred.true ];
      out = "1.6.5";
    }
    {
      cases = [ "8.13" lib.pred.true ];
      out = "1.5.0";
    }
    {
      cases = [ "8.12" lib.pred.true ];
      out = "1.4.0";
    }
    {
      cases = [ "8.11" lib.pred.true ];
      out = "1.3.2";
    }
    {
      cases = [ "8.10" lib.pred.true ];
      out = "1.2.1";
    }
    {
      cases = [ "8.9" lib.pred.true ];
      out = "1.1.0";
    }
    {
      cases = [ "8.8" lib.pred.true ];
      out = "20190311";
    }
    {
      cases = [ "8.7" lib.versions.isLe "1.8" ];
      out = "1.0.0";
    }
    {
      cases = [ "8.6" lib.pred.true ];
      out = "20171102";
    }
    {
