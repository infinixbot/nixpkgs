...
mkCoqDerivation {
  ...
  defaultVersion = lib.switch [ coq.version mathcomp.version ] [
    {
      cases = [ (lib.versions.range "8.10" "8.16") (lib.versions.range "1.12.0" "1.15.0") ];
      out = "1.2.1";
    }
    {
      cases = [ (lib.versions.range "8.10" "8.15") (lib.versions.range "1.12.0" "1.14.0") ];
      out = "1.2.0";
    }
    {
      cases = [ (lib.versions.range "8.10" "8.14") (lib.versions.range "1.11.0" "1.12.0") ];
      out = "1.1.2";
    }
  ] null;
