...
builtins.intersectAttrs super {
    ...
    (
      ...
      in
      {
        ...
        hledger-ui_1_34 = installHledgerExtraFiles "" (
          doDistribute (
            super.hledger-ui_1_34.override {
              hledger = self.hledger_1_34;
              hledger-lib = self.hledger-lib_1_34;
            }
          )
        );
        hledger-web_1_34 = installHledgerExtraFiles "" (
          hledgerWebTestFix (
            doDistribute (
              super.hledger-web_1_34.override {
                hledger = self.hledger_1_34;
                hledger-lib = self.hledger-lib_1_34;
              }
            )
  ...
  mpi-hs =
    let
      validMpi = [ "openmpi" "mpich" "mvapich" ];
