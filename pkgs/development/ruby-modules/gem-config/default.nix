  ...
  prometheus-client-mmap =
    ...
    // lib.optionalAttrs (lib.versionAtLeast attrs.version "1.0") {
      ...
      cargoDeps = rustPlatform.fetchCargoVendor {
        ...
        hash =
          if lib.versionAtLeast attrs.version "1.1.2" then
            "sha256-8EpYU6MSzMG3RzneDx0GwZ2N46Po8FdA/7Khy/7KHWo="
          else if lib.versionAtLeast attrs.version "1.1.1" then
            "sha256-V4NlFgVJy+V9fdbZWObn52H91IFSIU1seErMcxh1x5w="
          else
            "sha256-GFRIjvBPhqT4h6gE+GF32WW1wgZTaaHXRF7tIXnRM1Q=";
      };
      nativeBuildInputs = [
        cargo
        rustc
