...
(chromium.override { upstream-info = info.chromium; }).mkDerivation (base: {
  ...
  patches =
    base.patches
    ++ lib.optional (lib.versionAtLeast info.version "29" && lib.versionOlder info.version "30")
      (substituteAll {
  ...
  gnFlags =
    ...
    // lib.optionalAttrs (lib.versionAtLeast info.version "29") { v8_expose_public_symbols = true; }
    // {
