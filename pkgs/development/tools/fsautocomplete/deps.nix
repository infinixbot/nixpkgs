...
[
  (fetchNuGet {
    pname = "altcover";
    version = "8.3.838";
    hash = "sha256-1kVHQ9LVW5UeDQM9akVtHAWqaek9xyGdsbj3fnkuC1E=";
  })
  (fetchNuGet {
    pname = "BenchmarkDotNet";
    version = "0.13.5";
    hash = "sha256-DFj37xGD1ZS+kuRwC6/ry6fCcB7Ua3pUeSEcpayh5Ys=";
  })
  (fetchNuGet {
    pname = "BenchmarkDotNet.Annotations";
    version = "0.13.5";
    hash = "sha256-wm/xxRicbpcX2+k+pY0bciAqcJDcD/YTZUOBbaCR/Zc=";
  })
  (fetchNuGet {
    pname = "CliWrap";
    version = "3.4.4";
    hash = "sha256-qBNxZ9XE8Ggml6SJO0APLwLzAZPEyK9oLIG6juHSx7w=";
  })
  (fetchNuGet {
  ...
  (fetchNuGet {
    ...
    version = "7.0.1";
    hash = "sha256-+RgiTMxrNWj3ugtdookh/xZSSZ9N2AAVwwpVC6w7vKM=";
  })
  (fetchNuGet {
    pname = "Destructurama.FSharp";
    version = "1.2.0";
    hash = "sha256-2xoQITsoczLJZ01q5RpZf6QAyadTGFfiT2SKPxVCc30=";
  })
  (fetchNuGet {
    pname = "DiffPlex";
    version = "1.7.1";
  ...
  (fetchNuGet {
    ...
    version = "5.0.2";
    hash = "sha256-0Hrww0XM6T5vtk2pjDcurODd0h6iq4g65MMJBE2TPz8=";
  })
  (fetchNuGet {
    pname = "DotNet.ReproducibleBuilds";
    version = "1.1.1";
    hash = "sha256-+E+F4W9AbqVBwbbwPvaaM62btwF4h8dxlZ+GzRfvQHE=";
  })
  (fetchNuGet {
    pname = "Expecto";
    version = "10.1.0";
    hash = "sha256-Cecf3x1iHWSqXzasGsyEiuUgjeLCs14qXJ6KC2Lx/og=";
  })
  (fetchNuGet {
    pname = "Expecto.Diff";
    version = "9.0.4";
    hash = "sha256-8jhTfIWb0aJwUXUihqdjt8PnuvGZCOiVhye3WfKy5hk=";
  })
  (fetchNuGet {
    pname = "fantomas";
    version = "6.3.1";
    hash = "sha256-mPuY2OwVK6dLtI+L8SIK5i7545VQ0ChhUPdQwBlvcE4=";
  })
  (fetchNuGet {
    pname = "Fantomas.Client";
    version = "0.9.0";
    hash = "sha256-LUnFBYZ7LYhPcTRcXx3KfpnY+TRGIGdw8md6F8zkPf4=";
  })
  (fetchNuGet {
    pname = "FParsec";
    version = "1.1.1";
  ...
  (fetchNuGet {
    ...
    version = "0.26.0";
    hash = "sha256-4Y433meN0SKb/0JFzStpwScpC1Nly+HCjuihiVGVeE8=";
  })
  (fetchNuGet {
    pname = "FSharp.Compiler.Service";
    version = "43.8.300";
    hash = "sha256-i/vULPC06ZPAsY2t45ZbHjWXViBV1C0FWsN3D94nGmI=";
  })
  (fetchNuGet {
  ...
  (fetchNuGet {
    ...
    version = "1.2.13";
    hash = "sha256-P5stVsJ/IrfAO5Z21Vik2FN1c/AfDoQF9SAEiMKBgZo=";
  })
  (fetchNuGet {
  ...
  (fetchNuGet {
    ...
    version = "0.21.2";
    hash = "sha256-AH5W55M6IJiS4ywvVgBMk79bLmXKE7Q4APK2+vNjn4M=";
  })
  (fetchNuGet {
    pname = "FSharpx.Async";
    version = "1.14.1";
  ...
  (fetchNuGet {
    ...
    version = "4.4.0";
    hash = "sha256-XsUBzpwDeIOr5DqXsw7KR76M2wcB/n2rjEUABUqMtSg=";
  })
  (fetchNuGet {
    pname = "FsToolkit.ErrorHandling.TaskResult";
    version = "4.4.0";
    hash = "sha256-OJMBFzAYoQqHoQ0T3NZ6BkOIJKbHqkbBiKppt2Ml/OE=";
  })
  (fetchNuGet {
  ...
  (fetchNuGet {
    ...
    version = "2.0.1";
    hash = "sha256-DkhXkjt4aeRkgzvgZSLA1gyINlrkbDL5uQfTbqsLrZQ=";
  })
  (fetchNuGet {
    pname = "Google.Protobuf";
    version = "3.22.0";
    hash = "sha256-x8ZwDIy+uodM/2H2U4VoSFe8o35LI3+HA0vK3DDtXfI=";
  })
  (fetchNuGet {
    pname = "Grpc";
    version = "2.46.6";
  ...
  (fetchNuGet {
    ...
    version = "2.51.0";
    hash = "sha256-0CotAbUEJFJ4ed2P1p6Yu3cc0/6Dpz8NlPiiGIpSmNA=";
  })
  (fetchNuGet {
    pname = "Grpc.Net.Common";
    version = "2.51.0";
    hash = "sha256-H+STGNVZyOK+jfMjn47MnN+UpHFW0xJrIoSRiYvj8aw=";
  })
  (fetchNuGet {
  ...
  (fetchNuGet {
    pname = "IcedTasks";
    version = "0.11.5";
    hash = "sha256-OJQfoUF9ZIr8tQBJjwGTM0B7Mhsh7n8vwrK8VrT9/FA=";
  })
  (fetchNuGet {
  ...
  (fetchNuGet {
    ...
    version = "0.11.0";
    hash = "sha256-AChoZnk+qr0SKsvqIcirrif8KEs/hl9qrExVktc7XfM=";
  })
  (fetchNuGet {
  ...
  (fetchNuGet {
    ...
    version = "0.65.0";
    hash = "sha256-n+kJQFf2EAiSnlP1QH/0EIo8Y8tHxZTXVQMeqTw6aio=";
  })
  (fetchNuGet {
    pname = "Ionide.ProjInfo.FCS";
    version = "0.65.0";
    hash = "sha256-IDbSOOD2bJ6bxfvw8xoxnEkW1fdXokV5qaVxa7KxWU4=";
  })
  (fetchNuGet {
    pname = "Ionide.ProjInfo.ProjectSystem";
    version = "0.65.0";
    hash = "sha256-GNXwArp1Y4Sq/yVKBOLLuhcYoTQ76Wnibxt/4IYHCJQ=";
  })
  (fetchNuGet {
    pname = "Ionide.ProjInfo.Sln";
    version = "0.65.0";
    hash = "sha256-FMtbVFnOxFnxFVkkw7ec8Hj9iZdiUisfF6LLjYT2Xbg=";
  })
  (fetchNuGet {
  ...
  (fetchNuGet {
    ...
    version = "17.6.3";
    hash = "sha256-xu4GNWtHgwOLOCyI/AfaXxPgWehHFQIYSDkLGLlAQT4=";
  })
  (fetchNuGet {
    pname = "Microsoft.Build.Locator";
    version = "1.5.3";
    hash = "sha256-5PXL9/sEmtM8xO8U8Ce9Dg3rrFKA7K/Ak5jU9Zz6oE4=";
  })
  (fetchNuGet {
    pname = "Microsoft.Build.Tasks.Core";
    version = "17.4.0";
    hash = "sha256-THxSNkjJY82lY6iahcH6PCoHjkDi7G7nK5O4i9GTo4k=";
  })
  (fetchNuGet {
  ...
  (fetchNuGet {
    ...
    version = "17.4.0";
    hash = "sha256-xyMwjD98ic4Bc3MSC31F9r4CFG1tRGODiXrEZxLm+tM=";
  })
  (fetchNuGet {
    pname = "Microsoft.CodeAnalysis";
    version = "4.5.0";
    hash = "sha256-3WFWy2PC0X3D/ho3OjEgTx0Wh3Y0+urDBBDnzceYNOw=";
  })
  (fetchNuGet {
  ...
  (fetchNuGet {
    ...
    version = "4.5.0";
    hash = "sha256-Szem/v7hUsx5NdG6Zt7pJ30mgqCbwR4WShPU89xgqEs=";
  })
  (fetchNuGet {
    pname = "Microsoft.CodeAnalysis.VisualBasic.Workspaces";
    version = "4.5.0";
    hash = "sha256-h0iLQdXKU/u/RHyrAeEHgRrsrSHHb/GaEP53d8j+MfI=";
  })
  (fetchNuGet {
  ...
  (fetchNuGet {
    ...
    version = "17.4.1";
    hash = "sha256-MauJBMP1gySvvAsuNB7m+KvcAWsexU9i/tOwavBDxi0=";
  })
  (fetchNuGet {
  ...
  (fetchNuGet {
    ...
    version = "17.4.1";
    hash = "sha256-Kl8ZAWCMFZcYEfPDr/YG4zfQEuEzlOuhWI40Zl2S4Qo=";
  })
  (fetchNuGet {
  ...
  (fetchNuGet {
    ...
    version = "1.1.1";
    hash = "sha256-Pyf/qCztg3ybe/5D070W1Huiaj9ZCq6Hsfkuv0VELBU=";
  })
  (fetchNuGet {
    pname = "Microsoft.SourceLink.Bitbucket.Git";
    version = "1.1.1";
    hash = "sha256-yR7+KmYQqNCUh1JrrZhwPy3KL9xUO0+ajlhlGOmJ7dw=";
  })
  (fetchNuGet {
  ...
  (fetchNuGet {
    ...
    version = "1.1.1";
    hash = "sha256-gfT9xzBXzmVlMR/2T2fTapA+udrYUNvP+bO6AhgDpTo=";
  })
  (fetchNuGet {
    pname = "Microsoft.TestPlatform.ObjectModel";
    version = "17.4.1";
    hash = "sha256-Qa059jbu0zIXHknnCYkrqFFZwXR8mpuihaTC65PjyGg=";
  })
  (fetchNuGet {
    pname = "Microsoft.TestPlatform.TestHost";
    version = "17.4.1";
    hash = "sha256-RIt6iAlpq52zaLy1X1dDAQkIVp/SGhAz6x7mYhGmMdk=";
  })
  (fetchNuGet {
  ...
  (fetchNuGet {
    ...
    version = "6.3.0";
    hash = "sha256-DMTS6vJJ5p0lpld2oXGEzcVk+mZV6vBgUTi5OJ9buBY=";
  })
  (fetchNuGet {
    pname = "OpenTelemetry";
    version = "1.3.2";
    hash = "sha256-6awzrYhug+Tq1R4uRl1Ry8SC+PPSz0o+hJLfWA67Me0=";
  })
  (fetchNuGet {
    pname = "OpenTelemetry.Api";
    version = "1.3.2";
    hash = "sha256-YXN8ijWIGq6/0CwQ88oSUlJ7zfCm17T3IXZUa2ZK9Dk=";
  })
  (fetchNuGet {
    pname = "OpenTelemetry.Exporter.OpenTelemetryProtocol";
    version = "1.3.2";
    hash = "sha256-OJI1qaTB1V6Ms4HPbgEyX75HqOf7hGjVgCzjiozN5pI=";
  })
  (fetchNuGet {
    pname = "OpenTelemetry.Instrumentation.Runtime";
    version = "1.0.0";
    hash = "sha256-NLxoW+nvQB6kssdFyJej168XmWVOOPccfS25H+15QQs=";
  })
  (fetchNuGet {
    pname = "Paket";
    version = "8.0.3";
    hash = "sha256-wAIzB3RURvy51UeMMrdHGI2ImKx1GDu3K1eglwEItYs=";
  })
  (fetchNuGet {
    pname = "Perfolizer";
    version = "0.2.1";
  ...
  (fetchNuGet {
    ...
    version = "0.14.2";
    hash = "sha256-Kufv0plq7ypcEeZdZja+PYja9U1aPyjt6IFy5EZ+56A=";
  })
]
