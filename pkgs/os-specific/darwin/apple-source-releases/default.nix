...
// {
  ...
  AvailabilityVersions =
    applePackage "AvailabilityVersions" "macos-14.4"
      "sha256-O9/EOsbK5ZXxh6iDSTwGWWrY5GX/viUwdfG3tdvZwcQ="
      { };
  bsdmake =
  ...
  libclosure =
    applePackage "libclosure" "osx-10.11.6" "sha256-L5rQ+UBpf3B+W1U+gZKk7fXulslHsc8lxnCsplV+nr0="
      { };
  libdispatch =
    applePackage "libdispatch" "osx-10.12.4" "sha256-xUqoG5JK4P3nXeoVUOBzodVK9fjH/I3xJ6WRtM39bdw="
      { };
  Libinfo =
  ...
  Libsystem =
    applePackage "Libsystem" "osx-10.12.6" "sha256-zvRdCP//TjKCGAqm/5nJXPppshU1cv2fg/L/yK/olGQ="
      { inherit (pkgs.darwin.apple_sdk) sdkRoot; };
  libutil =
