...

{
  ...
  components = {
    ...
    "apsystems" = ps: with ps; [ ]; # missing inputs: apsystems-ez1
    "aquacell" =
      ps: with ps; [
        fnv-hash-fast
        ifaddr
    ...
    "arve" = ps: with ps; [ ]; # missing inputs: asyncarve
    ...
    "emoncms" = ps: with ps; [ ]; # missing inputs: pyemoncms
    ...
    "ista_ecotrend" = ps: with ps; [ ]; # missing inputs: pyecotrend-ista
    ...
    "knocki" = ps: with ps; [ ]; # missing inputs: knocki
    "knx" =
      ps: with ps; [
        fnv-hash-fast
        home-assistant-frontend
    ...
    "solaredge" = ps: with ps; [ stringcase ]; # missing inputs: aiosolaredge
    "solaredge_local" = ps: with ps; [ ]; # missing inputs: solaredge-local
    "solarlog" = ps: with ps; [ ]; # missing inputs: solarlog_cli
    ...
    "telegram" = ps: with ps; [ python-telegram-bot ]; # missing inputs: python-telegram-bot.optional-dependencies.socks
