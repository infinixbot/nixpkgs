...

{
  ...
  components = {
    ...
    "airgradient" = ps: with ps; [ airgradient ];
    ...
    "airtouch5" = ps: with ps; [ airtouch5py ];
    ...
    "analytics_insights" = ps: with ps; [ python-homeassistant-analytics ];
    ...
    "aprilaire" = ps: with ps; [ pyaprilaire ];
    "aprs" =
      ps: with ps; [
        aprslib
        geopy
      ];
    "apsystems" = ps: with ps; [ apsystems-ez1 ];
    "aquacell" =
      ps: with ps; [
        aioaquacell
        fnv-hash-fast
    ...
    "arve" = ps: with ps; [ asyncarve ];
    "arwn" = ps: with ps; [ paho-mqtt_1 ];
    ...
    "azure_data_explorer" = ps: with ps; [ ]; # missing inputs: azure-kusto-data azure-kusto-ingest
    ...
    "bang_olufsen" = ps: with ps; [ mozart-api ];
    "bayesian" = ps: with ps; [ ];
    ...
    "bswitch" = ps: with ps; [ ];
    "bt_home_hub_5" = ps: with ps; [ bthomehub5-devicelist ];
    ...
    "compensation" = ps: with ps; [ numpy_1 ];
    ...
    "device_sun_light_trigger" = ps: with ps; [ pillow ];
    ...
    "digital_ocean" = ps: with ps; [ python-digitalocean ];
    ...
    "dominos" = ps: with ps; [ ]; # missing inputs: pizzapi
    "doods" =
      ps: with ps; [
        pillow
        pydoods
      ];
    "doorbird" = ps: with ps; [ doorbirdpy ];
    "dooya" = ps: with ps; [ ];
    "dormakaba_dkey" =
      ps: with ps; [
        aioesphomeapi
    ...
    "dsmr_reader" = ps: with ps; [ paho-mqtt_1 ];
    ...
    "energenie_power_sockets" = ps: with ps; [ ]; # missing inputs: pyegps
    ...
    "epic_games_store" = ps: with ps; [ ]; # missing inputs: epicstore-api
    ...
    "hardkernel" = ps: with ps; [ psutil-home-assistant ];
    ...
    "image" = ps: with ps; [ ];
    "image_processing" = ps: with ps; [ pyturbojpeg ];
    "image_upload" = ps: with ps; [ pillow ];
    "imap" = ps: with ps; [ aioimaplib ];
    "imgw_pib" = ps: with ps; [ ]; # missing inputs: imgw_pib
    "improv_ble" =
      ps: with ps; [
        aioesphomeapi
        aioruuvigateway
    ...
    "isal" = ps: with ps; [ isal ];
    "islamic_prayer_times" = ps: with ps; [ ]; # missing inputs: prayer-times-calculator-offline
    "ismartwindow" = ps: with ps; [ ];
    "iss" = ps: with ps; [ ]; # missing inputs: pyiss
    "ista_ecotrend" = ps: with ps; [ pyecotrend-ista ];
    ...
    "konnected" = ps: with ps; [ konnected ];
    ...
    "madeco" = ps: with ps; [ ];
    "mailbox" = ps: with ps; [ ];
    "mailgun" = ps: with ps; [ pymailgunner ];
    "manual" = ps: with ps; [ ];
    "manual_mqtt" = ps: with ps; [ paho-mqtt_1 ];
    "map" =
      ps: with ps; [
        fnv-hash-fast
        home-assistant-frontend
    ...
    "media_extractor" = ps: with ps; [ yt-dlp ];
    ...
    "microsoft_face" = ps: with ps; [ pyturbojpeg ];
    "microsoft_face_detect" = ps: with ps; [ pyturbojpeg ];
    "microsoft_face_identify" = ps: with ps; [ pyturbojpeg ];
    ...
    "motionmount" = ps: with ps; [ python-motionmount ];
    "mpd" = ps: with ps; [ mpd2 ];
    "mqtt" = ps: with ps; [ paho-mqtt_1 ];
    "mqtt_eventstream" = ps: with ps; [ paho-mqtt_1 ];
    "mqtt_json" = ps: with ps; [ paho-mqtt_1 ];
    "mqtt_room" = ps: with ps; [ paho-mqtt_1 ];
    "mqtt_statestream" = ps: with ps; [ paho-mqtt_1 ];
    ...
    "mystrom" = ps: with ps; [ python-mystrom ];
    ...
    "netio" = ps: with ps; [ ]; # missing inputs: pynetio
    "network" =
      ps: with ps; [
        fnv-hash-fast
        ifaddr
    ...
    "number" = ps: with ps; [ ];
    "nut" = ps: with ps; [ aionut ];
    "nutrichef" = ps: with ps; [ ];
    "nws" = ps: with ps; [ pynws ] ++ pynws.optional-dependencies.retry;
    ...
    "onboarding" = ps: with ps; [ pillow ];
    "oncue" = ps: with ps; [ aiooncue ];
    "ondilo_ico" = ps: with ps; [ ondilo ];
    "onewire" = ps: with ps; [ pyownet ];
    "onkyo" = ps: with ps; [ ]; # missing inputs: pyeiscp
    "onvif" =
      ps: with ps; [
        ha-ffmpeg
        onvif-zeep-async
    ...
    "openweathermap" = ps: with ps; [ pyopenweathermap ];
    ...
    "pepco" = ps: with ps; [ ];
    "permobil" = ps: with ps; [ mypermobil ];
    "persistent_notification" = ps: with ps; [ ];
    "person" = ps: with ps; [ pillow ];
    "pge" = ps: with ps; [ ];
    ...
    "prometheus" = ps: with ps; [ prometheus-client ];
    ...
    "pyload" = ps: with ps; [ pyloadapi ];
    "python_script" = ps: with ps; [ restrictedpython ];
    "qbittorrent" = ps: with ps; [ qbittorrent-api ];
    "qingping" =
      ps: with ps; [
        aioesphomeapi
        aioruuvigateway
    ...
    "raspberry_pi" = ps: with ps; [ psutil-home-assistant ];
    ...
    "reolink" = ps: with ps; [ reolink-aio ];
    "repairs" = ps: with ps; [ ];
    ...
    "rocketchat" = ps: with ps; [ rocketchat-api ];
    "roku" = ps: with ps; [ rokuecp ];
    "romy" = ps: with ps; [ romy ];
    ...
    "serial" = ps: with ps; [ pyserial-asyncio-fast ];
    ...
    "solarlog" = ps: with ps; [ solarlog-cli ];
    ...
    "stookwijzer" = ps: with ps; [ stookwijzer ];
    "stream" =
      ps: with ps; [
        av
        numpy_1
    ...
    "tedee" = ps: with ps; [ pytedee-async ];
    "telegram" =
      ps: with ps; [ python-telegram-bot ] ++ python-telegram-bot.optional-dependencies.socks;
    "telegram_bot" =
      ps: with ps; [ python-telegram-bot ] ++ python-telegram-bot.optional-dependencies.socks;
    ...
    "tessie" = ps: with ps; [ tesla-fleet-api ]; # missing inputs: tessie-api
    "text" = ps: with ps; [ ];
    ...
    "thethingsnetwork" = ps: with ps; [ ttn-client ];
    ...
    "twilio_call" = ps: with ps; [ twilio ];
    "twilio_sms" = ps: with ps; [ twilio ];
    ...
    "weatherflow_cloud" = ps: with ps; [ weatherflow4py ];
