...

{
  ...
  components = {
    ...
    "airgradient" = ps: with ps; [ ]; # missing inputs: airgradient
    ...
    "dsmr_reader" = ps: with ps; [ paho-mqtt ];
    ...
    "manual" = ps: with ps; [ ];
    "manual_mqtt" = ps: with ps; [ paho-mqtt ];
    "map" =
      ps: with ps; [
        fnv-hash-fast
        home-assistant-frontend
    ...
    "mqtt_json" = ps: with ps; [ paho-mqtt ];
    "mqtt_room" = ps: with ps; [ paho-mqtt ];
