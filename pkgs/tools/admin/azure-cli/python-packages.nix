...
let
  ...
  py = python3.override {
    packageOverrides = self: super: {
      ...
      azure-mgmt-batch =
        overrideAzureMgmtPackage super.azure-mgmt-batch "17.2.0" "tar.gz"
          "sha256-ihXjijfW5OzilXPegIxaiSdsmfJSDqHzUrhqcEyJhY0=";
      azure-mgmt-batchai =
      ...
      azure-mgmt-rdbms =
        overrideAzureMgmtPackage super.azure-mgmt-rdbms "10.2.0b12" "tar.gz"
          "sha256-WdTm0YxMXNHGcSGD38YZ1YmJaMjfLJC8OImXedcxDeE=";
      azure-mgmt-recoveryservicesbackup =
        overrideAzureMgmtPackage super.azure-mgmt-recoveryservicesbackup "8.0.0" "tar.gz"
          "sha256-Hakde59uvVcCkvFt9w69nVr7BjNrPU0Q/COcA0h7Cnw=";
      azure-mgmt-redis =
      ...
      azure-mgmt-sql =
        overrideAzureMgmtPackage super.azure-mgmt-sql "4.0.0b15" "tar.gz"
          "sha256-zSrDo3+ftYayOK/gvhf/PQ926e3qExtSj/yDgXC9VqA=";
