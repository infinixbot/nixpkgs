              ...
              patches =
                lib.optionals
                  (
                    ...
                    || (lib.versions.majorMinor php.version == "8.1")
                  )
                  [
                ...
                ++
                  lib.optionals
                    (lib.versions.majorMinor php.version == "8.2" && lib.versionOlder php.version "8.2.22")
                    [
                ...
                ++
                  lib.optionals
                    (lib.versions.majorMinor php.version == "8.3" && lib.versionOlder php.version "8.3.10")
                    [
                      (fetchpatch {
