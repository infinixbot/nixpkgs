...
self: super: with self; {
  ...
  openllm = callPackage ../development/python-modules/openllm { triton = self.triton-cuda; };
  ...
  # Protobuf 4.x
  protobuf4 = callPackage ../development/python-modules/protobuf/4.nix { protobuf = pkgs.protobuf; };
