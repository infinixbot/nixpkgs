...
self: super: with self; {
  ...
  proton-vpn-killswitch-network-manager-wireguard =
    callPackage ../development/python-modules/proton-vpn-killswitch-network-manager-wireguard
      { };
  ...
  proton-vpn-network-manager-wireguard =
    callPackage ../development/python-modules/proton-vpn-network-manager-wireguard
      { };
