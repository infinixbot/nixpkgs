...
let
  ...
  jobs = recursiveUpdateMany [
    ...
    (versionedCompilerJobs {
      ...
      # working as expected.
      cabal-install = lib.subtractLists [ compilerNames.ghc9101 ] released;
      Cabal_3_10_3_0 = lib.subtractLists [ compilerNames.ghc9101 ] released;
      Cabal-syntax_3_10_3_0 = lib.subtractLists [ compilerNames.ghc9101 ] released;
